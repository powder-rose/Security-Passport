...
const experienceItems = [
  ...
  {
    index: '03',
    label: 'География проектов',
    title: 'Работаем по всей России',
    text: 'Разрабатываем документы и сопровождаем проекты для организаций из разных регионов Российской Федерации. Работа возможна дистанционно и с выездом специалистов.',
  },
];
